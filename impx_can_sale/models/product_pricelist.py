        ...
        for product, qty, partner in products_qty_partner:
            ...
            for rule in items:
                ...
                if rule.customer_ids:
                    ...
                    if partner.filtered(lambda line: line.id not in rule.customer_ids.ids):
                        continue
...
class PricelistItem(models.Model):
    ...
    customer_ids = fields.Many2many('res.partner', string='Applies only to customers', domain="['|', ('company_id', '=', False), ('company_id', '=', company_id)]")